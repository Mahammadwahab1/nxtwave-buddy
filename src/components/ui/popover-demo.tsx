...
export function PopoverDemo() {
  ...
  const handleNext = () => {
    if (currentTip < tips.length - 1) setCurrentTip((v) => v + 1);
  };
  const handlePrev = () => {
    if (currentTip > 0) setCurrentTip((v) => v - 1);
  };
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm">Quick Tour</Button>
      </PopoverTrigger>
      <PopoverContent className="max-w-[280px] py-3 shadow-none" side="bottom" align="end" showArrow>
